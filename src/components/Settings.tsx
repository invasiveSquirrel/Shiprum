        ...
        <section className="bg-surface-container p-10 border border-outline-variant/10">
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              <div className="flex justify-between items-center group">
                 <div>
                    <h4 className="font-headline text-lg italic">Dynamic Synch</h4>
                    <p className="text-[10px] text-outline uppercase tracking-widest mt-1">Propagate theme to sub-apps</p>
                 </div>
                 <div className="w-12 h-6 bg-primary/20 p-1 flex items-center justify-end cursor-pointer">
                    <div className="w-4 h-4 bg-primary"></div>
                 </div>
              </div>
              <div className="flex justify-between items-center group opacity-40">
                 <div>
                    <h4 className="font-headline text-lg italic">Serif Dominance</h4>
                    <p className="text-[10px] text-outline uppercase tracking-widest mt-1">Force Newsreader across all UI</p>
                 </div>
                 <div className="w-12 h-6 bg-outline-variant/20 p-1 flex items-center justify-start cursor-not-allowed">
                    <div className="w-4 h-4 bg-outline"></div>
                 </div>
              </div>
           </div>
        </section>
